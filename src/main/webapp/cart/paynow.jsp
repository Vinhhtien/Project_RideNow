...
<head>
    ...
    <style>
        ...
        .pay-btn-primary:hover:not(.is-disabled) {
            background: var(--pay-accent-dark);
            transform: translateY(-2px);
            box-shadow: var(--pay-shadow-lg)
        }

        .pay-btn-primary.is-disabled {
            background: #3a3f4d;
            color: #97a0b6;
            cursor: not-allowed;
            opacity: .85
        ...
        .pay-step.is-active .pay-step__num {
            background: var(--pay-accent);
            color: #fff;
        ...
        .pay-step.is-active .pay-step__text {
            color: var(--pay-accent)
        }
        ...
        .pay-table td:nth-last-child(2), .pay-table td:nth-last-child(3) {
            text-align: right
        }
        ...
        .pay-alert {
            ...
            border-left: 4px solid var(--pay-warn);
            padding: 14px 16px;
            border-radius: 10px;
            margin: 0 0 16px;
        }
        ...
        .pay-actions .pay-btn-ghost, .pay-actions .pay-btn-primary {
            min-width: 280px
        }
...
<main class="pay-wrap">
            ...
            <table class="pay-table">
                ...
                <c:forEach var="r" items="${rows}">
                    <tr>
                        ...
                        <td><strong class="pay-text-accent"><fmt:formatNumber value="${r.toPayNow}" type="number"/>
                            đ</strong></td>
                        <td>
                            <c:choose>
                                <c:when test="${r.paymentStatus == 'pending'}">
                                    <span style="color:#f59e0b;font-weight:600"><i
                                            class="fas fa-clock"></i> Đang chờ</span>
                                </c:when>
                                <c:otherwise>
    ...
    <div id="bankSection" class="pay-card">
            ...
            <div class="pay-bank__details">
                ...
                <div class="pay-bank__row">
                    ...
                    <div style="display:flex;align-items:center;flex-wrap:wrap">
                        ...
                        <button class="pay-copy" type="button" onclick="copyText('${qrAccountNo}')"><i
            ...
            <fmt:formatNumber value="${grandTotal}" type="number"/> đ
                ...
                <div class="pay-bank__row">
                    ...
                    <div style="display:flex;align-items:center;flex-wrap:wrap">
                        ...
                        <button class="pay-copy" type="button" onclick="copyText('${qrAddInfo}')"><i
                                class="far fa-copy"></i> Copy
                        </button>
                    </div>
                </div>
        ...
        <div class="pay-total">
            ...
            <div class="pay-total__num" id="totalAmountDisplay"><fmt:formatNumber value="${grandTotal}" type="number"/>
                đ
            </div>
        ...
        <div class="pay-instructions">
            ...
            <ol>
                ...
                <li>Chuyển đúng số tiền: <strong id="instructionAmount"><fmt:formatNumber value="${grandTotal}"
                                                                                          type="number"/> đ</strong>.
                </li>
