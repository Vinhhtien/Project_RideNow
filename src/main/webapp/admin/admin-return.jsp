    ...
    <body class="admin">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="${ctx}/admin/dashboard" class="nav-item"><i
                ...
                <a href="${ctx}/adminpickup" class="nav-item"><i
                ...
                <a href="${ctx}/adminreturns" class="nav-item"><i
        ...
        <main class="content">
            ...
            <c:set var="totalItems" value="${not empty activeOrders ? activeOrders.size() : 0}"/>
            ...
            <section class="kpi-grid">
                <div class="kpi-card">
                    <div class="kpi-icon" style="background: linear-gradient(135deg, #f59e0b, #d97706);"><i
                ...
                <div class="kpi-card">
                    <div class="kpi-icon" style="background: linear-gradient(135deg, #3b82f6, #2563eb);"><i
                ...
                <div class="kpi-card">
                    <div class="kpi-icon" style="background: linear-gradient(135deg, #10b981, #059669);"><i
            ...
            <section class="panel">
                <div class="panel-header">
                    <h2><i class="fas fa-clipboard-list"></i> Đơn Hàng Đang Thuê (Trang ${currentPage} / ${totalPages > 0 ? totalPages : 1})</h2>
                    <div class="panel-stats">
                        <span class="stat-badge"><i
                                class="fas fa-list"></i> Tổng số: ${totalItems}</span>
                    </div>
                </div>
                    ...
                    <c:choose>
                        <c:when test="${empty activeOrders}">
                            <div class="empty-state">
                                ...
                                <a href="${ctx}/admin/dashboard" class="btn btn-primary" style="margin-top:1rem;">Quay lại
                                    Dashboard</a>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div class="table-container">
                                <table class="data-table">
                                    ...
                                    <tbody>
                                        <c:forEach var="o" items="${activeOrders}" begin="${startIndex}" end="${endIndex - 1}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="bike-info"><i class="fas fa-motorcycle"></i> ${o[3]}</div>
                                                </td>
                                                <td>
                                                    <div class="date-range">
                                                        <fmt:parseDate value="${o[4]}" pattern="yyyy-MM-dd" var="startDate"/>
                                                        <fmt:parseDate value="${o[5]}" pattern="yyyy-MM-dd" var="endDate"/>
                                                        <strong>Từ:</strong> <fmt:formatDate value="${startDate}"
                                                                        pattern="dd/MM/yyyy"/><br>
                                                        <strong>Đến:</strong> <fmt:formatDate value="${endDate}"
                                                                        pattern="dd/MM/yyyy"/>
                                                    </div>
                                                </td>
                                                <td><strong style="color:#3b82f6;"><fmt:formatNumber value="${o[6]}" type="currency"
                                                                  currencyCode="VND"/></strong>
                                                </td>
                                                <td><strong style="color:#059669;"><fmt:formatNumber value="${o[7]}" type="currency"
                                                                  currencyCode="VND"/></strong>
                                                </td>
                                                <td>
                                                    <fmt:formatDate value="${o[5]}" pattern="yyyyMMdd" var="endDateNumber"/>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${!canReturn}">
                                                            ...
                                                            <div class="return-info">Có thể trả từ: <strong>${endDateText}</strong>
                                                            </div>
                                                        </c:when>
                                                        ...
                                                        <c:when test="${isOverdue}">
                                                            <button type="button" class="btn btn-overdue btn-sm"
                                                                    ...
                                                                    data-bs-target="#overdueReturnModal${o[0]}">
                                                                <i class="fas fa-exclamation-triangle"></i> Trả Xe Trễ
                                                            </button>
                                                            <div class="overdue-info">
                                                                Quá hạn từ: <strong><fmt:formatDate value='${o[5]}'
                                                                                pattern='dd/MM/yyyy'/></strong>
                                                            </div>

                                                            <div class="modal fade" id="overdueReturnModal${o[0]}" tabindex="-1"
                                                                 aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content modal-overdue">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <p>Nhớ <strong>tính phí trễ</strong> theo chính sách
                                                                                trước khi hoàn cọc.</p>
                                                                            <div class="mb-3">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                ...
                                                                                <input type="number" class="form-control"
                                                                                       name="lateFeeInput" min="0" step="1000"
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item <c:if test="${currentPage == 1}">disabled</c:if>">
                                                <a class="page-link" href="${ctx}/adminreturn?page=${prevPage}"
                                                   aria-label="Previous">
                                            ...
                                            <c:forEach begin="1" end="${totalPages}" var="i">
                                                <li class="page-item <c:if test="${currentPage == i}">active</c:if>">
                                                    <a class="page-link" href="${ctx}/adminreturn?page=${i}">${i}</a>
                                                </li>
                                            </c:forEach>

                                            <li class="page-item <c:if test="${currentPage == totalPages}">disabled</c:if>">
                                                <a class="page-link" href="${ctx}/adminreturn?page=${nextPage}"
                                                   aria-label="Next">
