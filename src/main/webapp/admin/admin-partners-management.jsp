        ...
        <div class="action-toolbar">
            ...
            <div class="toolbar-right">
                <div class="search-box">
                    ...
                    <input id="partnerSearch" type="text" placeholder="Tìm kiếm partners..."
                           aria-label="Tìm kiếm partners">
                </div>
            </div>
        </div>
                                    ...
                                    <tr data-id="${partner.partnerId}">
                                        ...
                                        <td data-label="Địa chỉ">
                                            <div class="text-truncate"
                                                 style="max-width: 200px;">${partner.address}</div>
                                        </td>
...
<script>
    ...
    (function () {
        ...
        const getCellValue = (row, key) => {
            switch (key) {
                case 'id':
                    return ((row.children[0] && row.children[0].textContent) || '').trim().replace('#', '');
                case 'name':
                    return ((row.children[1] && row.children[1].textContent) || '').trim().toLowerCase();
                case 'address':
                    return ((row.children[2] && row.children[2].textContent) || '').trim().toLowerCase();
                case 'phone':
                    return ((row.children[3] && row.children[3].textContent) || '').trim();
                default:
                    return '';
            }
        };
