    ...
    <header class="content-header">
        <div class="header-left">
            ...
            <div class="breadcrumb">
                ...
                <span><a href="${pageContext.request.contextPath}/admin/bikes"
                         style="color:inherit;text-decoration:none">Motorbikes</a></span>
                    ...
                    <div class="gallery" id="gallery">
                        <div class="gallery-main">
                            ...
                            <div class="gallery-nav" id="navBtns" style="display:none">
                                <button type="button" class="gallery-btn" id="prevBtn" aria-label="Ảnh trước"><i
                                        class="fa-solid fa-chevron-left"></i></button>
                                <button type="button" class="gallery-btn" id="nextBtn" aria-label="Ảnh sau"><i
                ...
                <form method="post" id="mainForm"
                    ...
                    <div class="mb-form-grid">
                        ...
                        <div class="mb-form-group">
                            ...
                            >
                            <div class="mb-hint">Định dạng bắt buộc: <b>NNLN-NNNNN</b> (N=số, L=chữ A-Z). Ví dụ: <code>43E1-68932</code>
                            </div>
                            <small id="plateError" style="color:#ef4444; display:none;">Biển số không đúng định dạng. Ví
                                dụ hợp lệ: 43E1-68932</small>
                        </div>
...
<!-- Section ngày thuê (chỉ hiện khi chọn trạng thái "rented" và chỉ trong chỉnh sửa) -->
                        ...
                        <c:if test="${empty motorbike}">
                            <div class="mb-form-group full">
                                ...
                                <div id="partnerSelection"
                                     class="mb-owner-selection ${(empty prefill_ownerType or prefill_ownerType eq 'partner') ? 'active' : ''}">
                                    ...
                                    <c:if test="${empty partners}">
                                        <p style="color: red; font-size: 12px;">⚠️ Không có đối tác nào trong hệ
                                            thống</p>
                                    </c:if>
                                </div>
                    ...
                    <div class="mb-btn-group">
                        <a href="${pageContext.request.contextPath}/admin/bikes" class="mb-btn mb-btn-outline"><i
                                class="fas fa-arrow-left"></i> Quay lại</a>
                        <button type="submit" class="mb-btn mb-btn-primary"><i
                                class="fas fa-save"></i> ${empty motorbike ? 'Thêm Xe' : 'Cập nhật'}</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        function setupGallery() {
            ...
            function showImage(index) {
                ...
                allThumbs.forEach((t, j) => {
                    if (j === index) t.classList.add('active'); else t.classList.remove('active');
                });
            }
        }
