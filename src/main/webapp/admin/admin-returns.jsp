...
<!--       DEBUG INFO 
    ...
    <section class="stats-grid">
      ...
      <div class="stat-card">
        <div class="stat-value">
          <fmt:formatNumber value="${totalPendingAmount}" type="currency"/>
        </div>
      ...
      <div class="panel-header">
        ...
        <div class="panel-stats">
          <span class="stat-badge">
            ...
            Tổng số: ${empty refundOrders ? 0 : refundOrders.size()}
          </span>
        </div>
      </div>
    ...
    <section class="panel">
      <div class="panel-header">
        ...
        <div class="panel-stats">
          <span class="stat-badge">
            <i class="fas fa-list"></i>
            Tổng số: ${empty refundRequests ? 0 : refundRequests.size()}
          </span>
        </div>
      </div>
      <div class="panel-body">
                    ...
                    <tr>
                      ...
                      <td>
                        <strong style="color: #3b82f6;">
                          <fmt:formatNumber value="${req.depositAmount}" type="currency"/>
                        </strong>
                      </td>
                      <td>
                        <strong style="color: #059669;">
                          <fmt:formatNumber value="${req.refundAmount}" type="currency"/>
                        </strong>
                      </td>
                      <td>
                        ...
                        <div class="action-buttons">
                          ...
                          <c:if test="${req.status == 'pending' || req.status == 'processing'}">
                            <form method="post" action="${pageContext.request.contextPath}/adminreturns" style="display:inline;">
                              ...
                              <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Xác nhận từ chối yêu cầu hoàn cọc này?')">
