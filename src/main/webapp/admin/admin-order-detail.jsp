                      ...
                      <c:choose>
                        ...
                        <div class="payment-breakdown">
                            <div class="breakdown-item">
                                ...
                                <div class="breakdown-value"><fmt:formatNumber value="${order.orderTotal}"
                                                                               type="currency"/></div>
                            </div>
                            <div class="breakdown-item">
                            ...
                            <div class="breakdown-item">
                                ...
                                <div class="breakdown-value"><fmt:formatNumber value="${order.orderTotal + 500000}"
                                                                               type="currency"/></div>
                            </div>
                        </div>
                        ...
                        <div class="financial-summary">
                            <div class="summary-card">
                                ...
                                <div class="value"><fmt:formatNumber value="${order.orderTotal + 500000}"
                                                                     type="currency"/></div>
                            </div>
                            <div class="summary-card">
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>amount-zero</c:otherwise>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <fmt:formatNumber value="${(order.orderTotal + 500000) - order.totalPaid}"
                                                              type="currency"/>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            ...
                            <div class="summary-card">
                                ...
                                <c:if test="${not empty order.lastPaidAt}">
                                    <div class="sub">Lần cuối: <fmt:formatDate value="${order.lastPaidAt}"
                                        ...
                                        <div class="refund-details">
                                            ...
                                            <div class="refund-detail">
                                                ...
                                                <div class="refund-value" style="color:#065f46;font-size:1.1rem;">
                                                    <strong>
                                                        <fmt:formatNumber
                                                                value="${empty refund.refundAmount ? 0 : refund.refundAmount}"
                                                                type="currency"/>
                                                    </strong>
                                                </div>
                                            </div>
                      ...
                      <span style="color:#dc2626;">
                        -<fmt:formatNumber value="${refund.damageFee}" type="currency"/>
                                        ...
                                        <div style="margin-top:1rem;padding-top:1rem;border-top:1px solid #bae6fd;">
                                            ...
                                            <div style="font-size:0.875rem;color:#6b7280;margin-top:0.25rem;">
                                                <fmt:formatDate value="${refund.inspectedAt}"
                        ...
                        <table class="data-table">
                            ...
                            <c:forEach var="it" items="${items}" varStatus="status">
                                <tr>
                                    ...
                                    <td>${it.quantity}</td>
                                    <td><strong><fmt:formatNumber value="${it.lineTotal}" type="currency"/></strong>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
