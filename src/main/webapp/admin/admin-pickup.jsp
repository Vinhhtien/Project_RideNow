                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="date-range">
                                            <strong>Từ:</strong> <fmt:formatDate value="${o[4]}"
                                        ...
                                        <c:choose>
                                            <c:when test="${!canPickup}">
                                                ...
                                                <div class="pickup-info">
                                                    Có thể nhận từ: <strong><fmt:formatDate value="${o[4]}"
                                            ...
                                            <c:when test="${isOverdue}">
                                                ...
                                                <div class="overdue-info">
                                                    Quá hạn từ: <strong><fmt:formatDate value="${o[4]}"
                                                                                        pattern="dd/MM/yyyy"/></strong>
                                                </div>

                                                <!-- Modal cho đơn quá hạn -->
                                                <div class="modal fade" id="overdueModal${o[0]}" tabindex="-1"
                                                     aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content modal-overdue">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p>Ngày thuê: <fmt:formatDate value="${o[4]}"
                                                                                              pattern="dd/MM/yyyy"/></p>
                                                                <p>Vui lòng xác nhận tình trạng:</p>

                                                                <div class="mb-3">
                                                                    <label class="form-label">Ghi chú (tùy
                                                                        chọn):</label>
