...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="${pageContext.request.contextPath}/admin/dashboard" class="nav-item active"><i
    ...
    <section class="kpi-grid">
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-content">
                <div class="kpi-value">
                    <c:choose><c:when
                            test="${not empty k.pendingVerifications}">${k.pendingVerifications}</c:when><c:otherwise>5</c:otherwise></c:choose>
                </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-content">
                <div class="kpi-value">
                    <c:choose><c:when
                            test="${not empty k.bikesInMaintenance}">${k.bikesInMaintenance}</c:when><c:otherwise>3</c:otherwise></c:choose>
                </div>
    ...
    <div class="content-grid">
        <section class="panel">
            <div class="panel-header">
                ...
                <div class="header-actions">
                    <a class="btn btn-outline" href="${pageContext.request.contextPath}/admin/orders">View All
                        Orders</a>
                ...
                <div class="quick-actions-grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
                    <div class="action-card">
                        ...
                        <div class="action-content">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/partners" class="btn btn-outline"
                               style="margin-top: .5rem; padding: .25rem .75rem; font-size: .75rem;">Get Started</a>
                        </div>
                    </div>
                    <div class="action-card">
                        ...
                        <div class="action-content">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/partners" class="btn btn-outline"
                               style="margin-top: .5rem; padding: .25rem .75rem; font-size: .75rem;">View List</a>
                        </div>
                    </div>
                    <div class="action-card">
                        ...
                        <div class="action-content">
                            ...
                            <div class="action-desc">Partners using default password:
                                <strong><c:choose><c:when
                                        test="${not empty k.partnersWithDefaultPassword}">${k.partnersWithDefaultPassword}</c:when><c:otherwise>2</c:otherwise></c:choose></strong>
                            </div>
                ...
                <div class="maintenance-list">
                    <c:forEach var="b" items="${maintenanceBikes}">
                        <div class="maintenance-item">
                            ...
                            <div class="maintenance-status"><i class="fas fa-tools"></i><span>Under Maintenance</span>
                            </div>
                        </div>
                    </c:forEach>
                    <c:if test="${empty maintenanceBikes}">
                        <div style="text-align:center; padding:2rem; color:var(--text-light);">
                            <i class="fas fa-check-circle"
                               style="font-size:2rem; margin-bottom:1rem; color:var(--success-color);"></i>
        ...
        <section class="panel">
            <div class="panel-header">
                ...
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/feedback">View All <i
                ...
                <div class="feedback-list">
                    <div class="feedback-item">
                        <div class="feedback-header">
                            ...
                            <div class="rating"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                    class="fas fa-star"></i><i class="fas fa-star"></i><i
                                    class="fas fa-star-half-alt"></i></div>
                        </div>
                        <div class="feedback-content">Dịch vụ thuê xe rất tốt, xe mới và vận hành ổn định. Nhân viên hỗ
                            trợ nhiệt tình.
                        </div>
                    ...
                    <div class="feedback-item">
                        ...
                        <div class="feedback-content">Xe hơi cũ một chút nhưng giá cả hợp lý. Quy trình thuê xe nhanh
                            chóng.
                        </div>
