...
<div class="wrap">
    ...
    <div class="card">
        <form method="get" action="${pageContext.request.contextPath}/viewreviewservlet" class="toolbar"
              autocomplete="off">
            <input class="input" type="text" name="bikeId" placeholder="Lọc theo Bike ID (tuỳ chọn)"
                   value="${param.bikeId}" inputmode="numeric"/>
            ...
            <c:when test="${empty REVIEWS}">
                <div class="empty-state">
                    ...
                    <div style="margin-top:10px">
                        <a class="btn btn-ghost" href="${pageContext.request.contextPath}/viewmotorbike">→ Xe của
                            tôi</a>
                    </div>
                </div>
            </c:when>
