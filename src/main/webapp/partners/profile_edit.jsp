...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-primary {
            background: linear-gradient(180deg, #7da1ff, #6c8cff);
            color: #0a0f21;
...
<div class="wrap">
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <form id="editForm" method="post" action="${pageContext.request.contextPath}/partner?action=updateProfile"
        ...
        <div class="card">
            ...
            <div class="preview">
                <div class="kv"><b>Tên tài khoản</b>
                    <div id="pvAccountName"><c:out
                            value="${sessionScope.partnerName != null ? sessionScope.partnerName : ''}"/></div>
                </div>
                <div class="kv"><b>Tên cửa hàng</b>
                    <div id="pvName"><c:out value="${partner.fullname}"/></div>
                </div>
                <div class="kv"><b>Số điện thoại</b>
                    <div id="pvPhone"><c:out value="${partner.phone}"/></div>
                </div>
                <div class="kv"><b>Địa chỉ</b>
                    <div id="pvAddress"><c:out value="${partner.address}"/></div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <form id="pwdForm" method="post" action="${pageContext.request.contextPath}/partner?action=updatePassword"
                  autocomplete="off">
                <div class="form-grid" style="grid-template-columns:1fr;">
                    <div class="fg">
                        ...
                        <div class="pw-field">
                            ...
                            <button type="button" class="eye-btn" data-target="newPassword" data-show="0"
                                ...
                                <!-- eye closed -->
                                <svg class="icon-closed" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2">
                    ...
                    <div class="fg">
                        ...
                        <div class="pw-field">
                            ...
                            <button type="button" class="eye-btn" data-target="confirmPassword" data-show="0"
                                    aria-label="Hiện/Ẩn mật khẩu">
                                <svg class="icon-open" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2">
                                    <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7Z"/>
...
<script>
    (function () {
        ...
        phone.addEventListener('input', () => {
            phone.value = clamp10(phone.value);
            updatePreview();
            validateAll();
        });
