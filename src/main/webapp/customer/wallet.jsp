                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${t.type == 'payment'}">
                                            <span class="badge pending"><i
                                                    class="fas fa-credit-card"></i> Thanh toán</span>
                                        </c:when>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${t.amount >= 0}">
                                            <span class="amount positive">+<fmt:formatNumber value="${t.amount}"
                                                                                             type="number"/> đ</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span class="amount negative"><fmt:formatNumber value="${t.amount}"
                                                                                            type="number"/> đ</span>
                                        </c:otherwise>
                                    </c:choose>
                                </td>
