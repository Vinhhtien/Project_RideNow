...
public class AdminOrdersServlet extends HttpServlet {
    ...
    private Date parse(String s){ try { return (s==null||s.isBlank())?null:DF.parse(s);} catch(Exception e){return null;} }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try { pageSize = Math.max(1, Integer.parseInt(req.getParameter("pageSize"))); } catch (Exception ignore) {}
