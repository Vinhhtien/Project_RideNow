...
public class AdminDAO implements IAdminDAO {
    ...
    public int countCustomers() {
        return singleInt("SELECT COUNT(*) FROM Customers");
    }

    @Override
    public int countPartners() {
        return singleInt("SELECT COUNT(*) FROM Partners");
    }

    @Override
    public int countBikes() {
        return singleInt("SELECT COUNT(*) FROM Motorbikes");
    }

    @Override
    public int countOrders() {
        return singleInt("SELECT COUNT(*) FROM RentalOrders");
    }
    ...
    @Override
    public List<OrderListItem> findLatestOrders(int limit) {
        String sql = """
    ...
    @Override
    public List<String[]> findBikesMaintenance(int limit) {
        String sql = """
